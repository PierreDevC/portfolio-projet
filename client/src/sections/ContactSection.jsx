  ...
  return (
    <section id="contact" className="py-24 bg-white dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-6">
        <p className="text-sm font-semibold text-violet-600 dark:text-violet-400 uppercase tracking-widest mb-3">Contact</p>
        <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-12">Travaillons ensemble</h2>
        <div className="grid md:grid-cols-2 gap-12">
          <div className="flex flex-col gap-6">
            <p className="text-gray-600 dark:text-gray-400">Vous avez un projet en tête ? N'hésitez pas à me contacter, je réponds généralement sous 24h.</p>
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <input name="from_email" type="email" placeholder="Votre email" required
              className="px-4 py-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500" />
